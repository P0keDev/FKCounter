...
import dev.p0ke.fkcounter.gui.elements.ButtonFancy;
import dev.p0ke.fkcounter.gui.elements.ButtonTitle;
import dev.p0ke.fkcounter.gui.elements.ButtonToggle;
...
public class FKCounterSettingsGui extends GuiScreen {
	...
	public void actionPerformed(GuiButton button) {
		...
		if(button instanceof ButtonFancy) {
			if(button.id == 100) {
				Minecraft.getMinecraft().displayGuiScreen(new LocationEditGui(FKCounterMod.instance().getHudManager(), this));
			}
		}
	}
